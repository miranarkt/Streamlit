...
st.markdown("_Contexte : Missionés par l\'entreprise « Extra Fruit », vous devez définir la cible pour le lancement de la campagne de promotion web #WebFruitSummer._")
